...
/**  Dibujo2     por Michael Gonzalez y Mariano Benito. Version 3.3.
     Octubre 2012. <p>
     ...
     ********   <p>
     ...
     dibujaImagen(xOrigen,yOrigen,nombreFichero,angulo) <p>
     <p>
...
public class Dibujo2 extends JFrame implements ActionListener {
    ...
    private class Atributos {
        ...
        ColorFig2 col = ColorFig2.negro;
        ColorFig2 colRelleno = ColorFig2.blanco;
        int grosorLapiz = 1;
        int fontSize = 12;
    ...
    private class Imagen extends Figura {
        ...
        Imagen(int x, int y, String filename,int angulo) {
            super();
            this.x = x;
            this.y = y;
            this.angulo=angulo;
        ...
        void dibuja(Graphics2D g) {
            ...
            g.drawImage
                (op.filter(im, null), x-(int) locationX, y- (int) locationY, null);
     ...
     */
    public Dibujo2(String titulo, int ancho, int alto) {
        super(titulo);
        this.ancho = ancho;
        this.alto = alto;
     ...
     */
    public void ponColorLapiz(ColorFig2 color) {
     ...
     */
    public void ponRelleno(ColorFig2 color) {
     ...
     */
    public void borra(ColorFig2 color) {
        figuras.clear();
     ...
     */
    public void dibujaImagen(int x, int y, String filename, int angulo) {
        if (lienzoLimitado && 
            (x < 0 || x > ancho || y < 0 || y > alto)) 
        {
            ...
            figuras.add(new Imagen(x, y, filename, angulo));
        }
    }
